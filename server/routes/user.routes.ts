...
import { getFriendInfo, getUser, search,updateUser } from "../controllers/user.controller";
...
router.put('/update', authenticate, tryCatch(updateUser)); //route to update user info
router.get('/get/info', tryCatch(getFriendInfo)); //route to get info of friend
