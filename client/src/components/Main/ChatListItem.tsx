...
export default function ChatListItem({ image, name, lastMessage, lastMessageTime, notification, isActive }: props) {
    return (
        <>
            <div className="flex justify-between gap-2 p-4 text-gray-200 hover:bg-gray-100">
                <div className="flex gap-2 w-5/6">
                    ...
                    <div className="flex flex-col gap-2 w-full text-nowrap overflow-hidden">
                        ...
                        <p className="text-sm overflow-hidden text-ellipsis">{lastMessage}</p>
                    </div>
                </div>
