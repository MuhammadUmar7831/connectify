        ...
        <div className="p-4 flex gap-2">
            ...
            <div className="flex gap-2 w-full">
                <div className="flex flex-col gap-4 w-full">
                    <Skeleton className="bg-gray-200 w-full max-w-32 h-4 rounded-md animate-pulse" />
                    <Skeleton className="bg-gray-200 w-full max-w-52 h-2 rounded-md animate-pulse" />
                </div>
